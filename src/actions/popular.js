 ...
 * @returns {Function}
 */
export function getPopularList(start,city,count) {
    return function (dispatch, getState) {
        //设置加载动画
        dispatch(setPopular({
            showLoading: true
        }));
        return fetch(configs.HOST+'/v2/movie/in_theaters?city='+city+'&start='+start+'&count='+count)
...
export function setPopular(data) {
    return {
